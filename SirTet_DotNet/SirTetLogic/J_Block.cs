...
namespace SirTetLogic
{
    ...
    public class J_Block : Block
    {
        ...
        /// <summary>
        /// Initialize a new instance of the <see cref="J_Block"/> class
        /// </summary>
        /// <param name="middleX">Index of column</param>
        /// <param name="middleY">Index of row</param>
        public J_Block(int middleX, int middleY)
        {
            middlePoint = new Point(middleX, middleY);
            restPoints = new Point[3] { new Point(middleX - 1, middleY - 1), new Point(middleX - 1, middleY), new Point(middleX + 1, middleY) };
        }
        /// <summary>
        ...
        public override bool IfBlockOutOfGridOnRotate(int gridX)
        {
            switch(rotationPose)
            {
                case 0:
                    ...
                    break;
                case 1:
                    if(restPoints[1].Get()[0] + 1 >= gridX - 1 || restPoints[2].Get()[0] - 1 <= 0)
                        return true;
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    if(restPoints[1].Get()[0] - 1 <= 0 || restPoints[2].Get()[0] + 1 >= gridX - 1)
                        return true;
                    break;
            }
            return false;
        ...
        public override string GetBlockType() => "J_Block";
